...
Следовательно, $P(A) dot P(A_i | A) = P(A_i) dot P(A | A_i)$, откуда

$ P(A_i | A) = (P(A_i) dot P(A | A_i))/P(A), i = 1, 2, ... $
...
_Необходимость_: Пусть $A$ и $B$ --- независимы. По определению верно $P(A inter B) = P(A) dot P(B)$.

Тогда

$ P(A|B) = P(A inter B )/P(B) = (P(A) dot P(B))/P(B) = P(A). $

_Достаточность_: Пусть $P(A | B) = P(A)$. По теореме умножения вероятностей
