...
Пусть $X$ и $Y$ --- множества прозвольной природы, в которых мы выделим $S_X$ и $S_Y$ --- классы подмножеств в $X$ и $Y$ соответственно.
...
$xi ~ N(a, sigma^2)$, $a$ --- среднее значение (матожидание) величины, $sigma$ --- мера отклонения величины от среднего (дисперсия).
